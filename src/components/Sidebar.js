...
export default function Sidebar({ isOpen, onClose }) {
  ...
  // ✅ CRITICAL: Get role directly from user object (no extra fetch needed!)
        ...
        {(isAdmin || isSupport) && (
          <>
            ...
            <Link 
              ...
              className="flex items-center gap-2 hover:text-purple-400 min-h-[44px] bg-purple-900/20 rounded-lg px-3" 
              onClick={onClose}
            >
              <span>{isAdmin ? '👑' : '🛠️'}</span>
              <span>Dashboard</span>
            ...
            <Link 
              ...
              className="flex items-center gap-2 hover:text-purple-400 min-h-[44px] px-3" 
              onClick={onClose}
            >
              <span>✅</span>
        ...
        {isMusician && (
          <>
            ...
            <Link 
              ...
              className="flex items-center gap-2 hover:text-blue-400 min-h-[44px] px-3" 
              onClick={onClose}
            >
              <span>🏠</span>
              <span>Dashboard</span>
